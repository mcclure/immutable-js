...
declare module Immutable {
  ...
  export function SortedList<T,K=T>(emptyList:null, keyFn:(value:T)=>K, ltFn?:(a:K,b:K)=>boolean): SortedList<T,T>;
  ...
  export function SortedList<T,K=T>(collection: Iterable<T>, keyFn:(value:T)=>K, ltFn?:(a:K,b:K)=>boolean): SortedList<T,T>;
